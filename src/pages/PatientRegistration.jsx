...
export default function PatientRegistration() {
  ...
  const handleSubmit = () => {
    fetch("http://localhost:3000/api/v1/patients/create-patient", {
      method: "POST",
      body: JSON.stringify({
        name: name,
        address: address,
  ...
  return (
    <>
      ...
      <div className="donor_body">
        <h2 className="donor_heading">Patient Registration</h2>
        ...
        <button className="register_btn" type="submit" onClick={handleSubmit}>
          Register
        </button>
      </div>
    </>
